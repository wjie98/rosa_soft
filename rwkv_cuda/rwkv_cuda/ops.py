...
def rwkv7_albatross_forward_w0_fp16_dither_seq(state: Tensor, r: Tensor, w: Tensor, k: Tensor, v: Tensor, a: Tensor, b: Tensor, y: Tensor, elapsed_t: Tensor) -> None:
    return torch.ops.rwkv_cuda.rwkv7_albatross_forward_w0_fp16_dither_seq(state, r, w, k, v, a, b, y, elapsed_t)

def rwkv7_albatross_forward_w0_fp16_dither_one(state: Tensor, r: Tensor, w: Tensor, k: Tensor, v: Tensor, a: Tensor, b: Tensor, y: Tensor, elapsed_t: Tensor) -> None:
    return torch.ops.rwkv_cuda.rwkv7_albatross_forward_w0_fp16_dither_one(state, r, w, k, v, a, b, y, elapsed_t)
