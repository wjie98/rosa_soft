...
template<typename F> void rwkv7_clampw_cuda_forward(int batch_size, int seq_len, int num_heads, int head_size, int chunk_len, F* r, F* w, F* k, F* v, F* a, F* b, F* y, float* s, float* sa);
template<typename F> void rwkv7_clampw_cuda_backward(int batch_size, int seq_len, int num_heads, int head_size, int chunk_len, F* r, F* w, F* k, F* v, F* a, F* b, F* dy, float* s, float* sa, F* dr, F* dw, F* dk, F* dv, F* da, F* db);
...
void rwkv7_clampw_backward(
    at::Tensor& r, at::Tensor& w, at::Tensor& k, at::Tensor& v, at::Tensor& a, at::Tensor& b,
    at::Tensor& dy, at::Tensor& s, at::Tensor& sa,
