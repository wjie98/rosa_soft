...
void rwkv7_albatross_forward_w0_fp16_dither(at::Tensor& s0, at::Tensor& r, at::Tensor& w, at::Tensor& k, at::Tensor& v, at::Tensor& a, at::Tensor& b, at::Tensor& y, at::Tensor& elapsed_t) {
    int B = r.size(0);
    int T = r.size(1);
    int H = r.size(2);
