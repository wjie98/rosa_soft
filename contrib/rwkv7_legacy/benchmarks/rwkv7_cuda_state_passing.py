"""Legacy manual benchmark for the optional RWKV7 state-passing kernel."""
...
from rosa_soft.ops import rwkv7_statepassing_clampw_forward, rwkv7_statepassing_clampw_backward

np.set_printoptions(precision=4, suppress=True, linewidth=200)
torch.backends.cudnn.allow_tf32 = False
torch.backends.cuda.matmul.allow_tf32 = False

# Usage: python benchmarks/legacy/rwkv7_cuda_state_passing.py {fp32,bf16} {0,1}
